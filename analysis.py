...
if __name__ == '__main__':
    ...
    for fname in files:
        ...
        f,ax = pl.subplots()
        ii = segs == 'L'
        plot_time_slice (ax, ns[:,ii], n=1, marker='.', ls='None', label='L', xs=en_basis[ii])
        ii = segs == 'R'
        plot_time_slice (ax, ns[:,ii], n=1, marker='x', ls='None', label='R', xs=en_basis[ii])
        ii = segs == 'S'
